...
const TableOptions: ITxCoolTableOption = {
  headStyles,
  bodyStyles,
  headers: ['IDX', 'id', 'txHash', 'callbackUrl', 'lastStatusCode', 'status', 'requestBody', 'attemptCount', 'maxAttempts', 'lastAttemptAt', 'requestSignature', 'depositId', 'createdAt', 'updatedAt'],
