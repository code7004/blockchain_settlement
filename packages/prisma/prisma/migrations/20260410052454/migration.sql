/*
  ...
  - The values [SUCCESS] on the enum `SweepStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "SweepStatus_new" AS ENUM ('PENDING', 'BROADCASTED', 'CONFIRMED', 'FAILED', 'SKIPPED');
